...
import { changeBarber, deleteAppointment, getAppointment, getAppointments, reschedule, updateServices, updateStatus } from "../controllers/adminAppointment.controller";
