...
function WorkingSchedule() {
  ...
  if (isLoading || loading) {
    return <div className="barber-view-page">Đang tải...</div>;
  }
      ...
      <main>
        <header>
          <div>
            ...
            <p>Lịch chỉ đọc. Lễ tân và Admin chịu trách nhiệm điều phối.</p>
          </div>
          <nav>
            <Link to="/barber/dashboard">Tổng quan</Link>
