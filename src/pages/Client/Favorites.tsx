...
//   const [favorites, setFavorites] = useState<favoriteService.FavoriteHairstyle[]>([]);
...
//       setFavorites((prev) => prev.filter((f) => f.imageUrl !== imageUrl));
//     } catch {
//       // ignore
//     }
//   };
...
//               </li>
//               <li className="nav-item">
//                 <Link className="nav-link" to="/about.html">Giới thiệu</Link>
//               </li>
//               <li className="nav-item">
//                 <Link className="nav-link" to="/services.html">Dịch vụ</Link>
//               </li>
//               <li className="nav-item">
//                 <Link className="nav-link" to="/pricing.html">Bảng giá</Link>
//               </li>
...
//                   <li>
//                     <Link className="dropdown-item" to="/portfolio.html">
...
//               </li>
//               <li className="nav-item">
//                 <Link className="nav-link" to="/contact.html">Liên hệ</Link>
//               </li>
...
//               <Link to="/portfolio.html" className="button-1 mt-3">
//                 Khám phá thư viện
//                 <span />
//               </Link>
//             </div>
