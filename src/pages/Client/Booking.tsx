...
function Booking() {
  ...
  const chooseVoucher = (voucher: AvailableVoucher): void => {
    ...
    setVoucherMessage(`Đã chọn ${voucher.code}. Tổng tạm tính và tiền cọc đã cập nhật theo ưu đãi.`);
      ...
      />
        ...
        <aside className="booking-summary">
          ...
          <div className="booking-totals">
            ...
            {voucherCalculation && <small>Đã tạm giảm <b>{money(voucherCalculation.discountAmount)}đ</b> bằng voucher <b>{voucherCode}</b>.</small>}
            {depositRequired && <small>Đặt cọc 30% số tiền sau ưu đãi: <b>{money(depositAmount)}đ</b></small>}
          </div>
