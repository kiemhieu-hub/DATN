...
function Pricing() {
  return (
    <div>
        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbar">
            <ul className="navbar-nav ms-auto">
              ...
              <li className="nav-item"><a className="nav-link active" href="pricing.html">Pricing</a></li>
      ...
      {/* Header Banner */}
      <div className="banner-header valign bg-img bg-fixed" data-overlay-dark="5" data-background="img/slider/18.jpg">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 p-0 valign">
              <div className="content barber-pricing">
                <div className="menu-list mb-30">
                  <div className="item">
                    <div className="flex">
                      <div className="title">Perukar HairCut</div>
                ...
                <div className="menu-list mb-30">
                  <div className="item">
                    <div className="flex">
                      <div className="title">Haircut with Skin Fade</div>
                      <div className="dots"></div>
                ...
                <div className="menu-list mb-30">
                  <div className="item">
                    <div className="flex">
                      <div className="title">Haircut Razor skin fade</div>
                      <div className="dots"></div>
            ...
            <div className="col-md-6 p-0 order2 valign">
              <div className="content barber-pricing">
                <div className="menu-list mb-30">
                  <div className="item">
                    <div className="flex">
                      <div className="title">Basic Beard Trim</div>
                      <div className="dots"></div>
                ...
                <div className="menu-list mb-30">
                  <div className="item">
                    <div className="flex">
                      <div className="title">Beard Trim &amp; Line Up</div>
                      <div className="dots"></div>
                      <div className="price">$20</div>
                    </div>
                ...
                <div className="menu-list mb-30">
                  <div className="item">
                    <div className="flex">
                      <div className="title">Electric Razor</div>
                      <div className="dots"></div>
                      <div className="price">$15</div>
                    </div>
            ...
            <div className="col-md-6 p-0 valign">
              <div className="content barber-pricing">
                <div className="menu-list mb-30">
                  <div className="item">
                    <div className="flex">
                      <div className="title">Full Face Shave</div>
                      <div className="dots"></div>
                      <div className="price">$20</div>
                    </div>
                ...
                <div className="menu-list mb-30">
                  <div className="item">
                    <div className="flex">
                      <div className="title">Partial Face Shave</div>
                      <div className="dots"></div>
                      <div className="price">$15</div>
                    </div>
                ...
                <div className="menu-list mb-30">
                  <div className="item">
                    <div className="flex">
                      <div className="title">Head Shave</div>
                      <div className="dots"></div>
                      <div className="price">$25</div>
                    </div>
