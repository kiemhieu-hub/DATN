...
export const saveReceptionDateOverride=async(id:string,data:{date:string;startTime:string;endTime:string;isWorking:boolean;note:string})=>(await api.put(`/receptionist/barbers/${id}/date-override`,data)).data;
